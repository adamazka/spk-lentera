...
<header class="header">
    <div class="page-brand">
        <a class="link" href="">
            <span class="brand">Lentera Fajar
                {{-- <span class="brand-tip">Lentera</span> --}}
            </span>
            <span class="brand-mini">
                <img src="/img/res-logo.webp" width="45px">
            </span>
        </a>
    </div>
                    ...
                    <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                        <div>
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="/admin/img/users/u1.jpg" />
                                    </div>
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="/admin/img/users/u2.jpg" />
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="/admin/img/users/u3.jpg" />
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="/admin/img/users/u4.jpg" />
                                    </div>
                                    <div class="media-body">
                        ...
                        <div>
                            <a class="list-group-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="font-13">4 task compiled</div><small
                                            class="text-muted">22 mins</small>
                                    </div>
                                </div>
                            </a>
                            <a class="list-group-item">
                ...
                @auth
                    <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                        ...
                        @if (auth()->user()->id_role == '1')
                            <span></span>Admin Lentera<i class="fa fa-angle-down m-l-5"></i>
                        @endif
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        {{-- <a class="dropdown-item" href="profile.html"><i class="fa fa-user"></i>Profile</a> --}}
                        {{-- <a class="dropdown-item" href="profile.html"><i class="fa fa-cog"></i>Settings</a> --}}
                        <a class="dropdown-item" href="http://wa.me/6282139489646" target="_blank"><i
