    ...
    <div class="content-wrapper">
        ...
        <div class="page-content fade-in-up">
            <div class="ibox col-8 centered">
                <div class="ibox-head">
                    <div class="ibox-title">Tambah Data Guru</div>
                </div>
                <div class="ibox-body">
                    ...
                    <form class="mt-3" method="POST" action="/guru" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group">
                            <label>NUTPK</label>
                            <input class="form-control" type="number" name="nutpk" value="{{ old('nutpk') }}">
                        </div> -->
                        <!-- nama dan telpon -->
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="number" name="tlp_guru" 
                                    value="{{ old('tlp_guru') }}" maxlength="13"
                        ...
                        <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="number" name="no_ktp_guru"
                                    value="{{ old('no_ktp_guru') }}" maxlength="16"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    required>
                            </div>
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="number" name="no_kk_guru" 
                                    value="{{ old('no_kk_guru') }}" maxlength="16"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" placeholder="tanggal / bulan / tahun"
                                    value="{{ old('tanggal_lahir') }}" onfocus="(this.type='date')"
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" name="pen_akhir_guru"
                                    value="{{ old('pen_akhir_guru') }}">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Jabatan</label>
                                <input class="form-control" type="text" name="jabatan_guru"
                                    value="{{ old('jabatan_guru') }}">
                            </div>
                        </div>
                        <!-- alamat -->
                        <div class="form-group">
                            <label>Alamat<span class="text-danger"></span></label>
                            <textarea class="form-control" type="text" name="alamat_guru" value="{{ old('alamat_guru') }}" required></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" placeholder="tanggal / bulan / tahun"
                                    value="{{ old('tahun_masuk') }}" onfocus="(this.type='date')"
                                    onblur="(this.type='text')" name="tahun_masuk">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Tahun Keluar</label>
                                <input class="form-control" type="text" placeholder="tanggal / bulan / tahun"
                                    value="{{ old('tahun_keluar') }}" onfocus="(this.type='date')"
